...
<html>
    ...
    <form action="/admin/objects/edit/${o.id}" class="form-horizontal" method="post" enctype="multipart/form-data">
        <script>
            disDate(${object_edit_disabledDates})
        </script>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" required class="form-control" name="name" id="name" placeholder="Name" value="${o.name}"/>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                <input id="date" name="date" type="text" value="${o.date}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" required class="form-control" name="authors" id="authors" placeholder="authors" value="${o.authors}"/>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <input type="submit" value="Edit object" class="btn btn-default"/>
            </div>
        </div>
    </form>
    </body>
